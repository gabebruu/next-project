  ...
  return (
    <div className="min-h-screen bg-purple-100">
      <div className="max-w-4x1 mx-auto">
        <h1 className="text-7xl font-semibold text-black">Hello!💀</h1>

        <PrimeiroComponente />
        <ComponenteComUmaProp nome="Bruna" />
        ...
        <div id="toast-default" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
          ...
          <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-pink-500 dark:hover:bg-gray-700" data-dismiss-target="#toast-default" aria-label="Close">
